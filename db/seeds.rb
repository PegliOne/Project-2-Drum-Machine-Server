...
s7 = Sound.create :name => "Chord-3", :key_code => 81, :key_trigger => "Q", :url => "https://s3.amazonaws.com/freecodecamp/drums/Chord_3.mp3"
s8 = Sound.create :name => "Chord-2", :key_code => 87, :key_trigger => "W", :url => "https://s3.amazonaws.com/freecodecamp/drums/Chord_2.mp3"
s9 = Sound.create :name => "Chord-1", :key_code => 69, :key_trigger => "E", :url => "https://s3.amazonaws.com/freecodecamp/drums/Chord_1.mp3"
